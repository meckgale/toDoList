...
function renderTasks() {
  ...
  for (const task of _toDoList__WEBPACK_IMPORTED_MODULE_0__.tasks) {
      const listItem = document.createElement('li')
      listItem.dataset.id = task.id // Set a custom data attribute for the task ID
      const formattedDueDate = task.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate)), "eee do MMM yy") : 'not specified';
      listItem.innerHTML = `
...
function Task(title, dueDate = null, completed = false) {
